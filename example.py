...
frame_income_expense = Frame(root)
frame_income_expense.grid(row=1, column=0, columnspan=3)

label_expense = Label(frame_income_expense, text="Expense")
label_expense.grid(row=0, column=0, sticky="ew", padx=5)
label_income = Label(frame_income_expense, text="Income")
label_income.grid(row=0, column=1, sticky="ew", padx=5)

frame_2 = Frame(root)
frame_2.grid(row=2, column=0, columnspan=3)

label_expense_n = Label(frame_2, text="0.00")
label_expense_n.grid(row=0, column=0, sticky="e")
label_income_n = Label(frame_2, text="0.00")
